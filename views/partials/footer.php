    ...
    <script>  
            $(document).ready(function(){
                $('#update_form').on('submit', function(e){
                    ...
                    $.ajax({
                        type: "POST",
                        url: '/?controller=auth&method=edit',
                        data: {fullname: fullname,job: job},
                        success: function(response){
                            $('#name').empty();
                            $('#name').html(response);
    ...
    <!-- <script>  
        $(document).ready(function(){
            $('#register_form').on('submit', function(e){
                ...
                $.ajax({
                    type: "POST",
                    url: '/?controller=auth&method=registerSubmit',
                    data: {fullname: fullname,job: job,username: username,password: password},
                    success: function(response){
                        $('#content').empty();
        ...
        $(document).ready(function(){
            $('#login_form').on('submit', function(e){
                ...
                $.ajax({
                    type: "POST",
                    url: '/?controller=auth&method=loginSubmit',
